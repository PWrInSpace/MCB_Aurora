...
size_t pysd_get_sd_frame_size(rocket_data_t pysd_main, bool new_line_ending) {
    size_t string_size;
    if (new_line_ending == true) {
        string_size = snprintf(NULL, 0, "%d;%lu;%d;%f;%d;%d;%d;%d;%d;%f;%f;%d;%d;%f;%f;%f;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;\n", pysd_main.mcb.state, pysd_main.mcb.uptime, pysd_main.mcb.flight_time, pysd_main.mcb.battery_voltage, pysd_main.mcb.sensor_placeholder, pysd_main.vent_valve.waken_up, pysd_main.vent_valve.valve_state, pysd_main.vent_valve.thermistor1, pysd_main.vent_valve.thermistor2, pysd_main.vent_valve.tank_pressure, pysd_main.vent_valve.battery_voltage, pysd_main.main_valve.waken_up, pysd_main.main_valve.valve_state, pysd_main.main_valve.thermocouple1, pysd_main.main_valve.thermocouple2, pysd_main.main_valve.battery_voltage, pysd_main.recovery.isArmed, pysd_main.recovery.isTeleActive, pysd_main.recovery.easyMiniFirstStage, pysd_main.recovery.easyMiniSecondStage, pysd_main.recovery.telemetrumFirstStage, pysd_main.recovery.telemetrumSecondStage, pysd_main.recovery.firstStageDone, pysd_main.recovery.secondStageDone, pysd_main.recovery.firstStageContinouity, pysd_main.recovery.secondStageContinouity, pysd_main.recovery.separationSwitch1, pysd_main.recovery.separationSwitch2, pysd_main.recovery.pressure1, pysd_main.recovery.pressure2);
    } else {
        string_size = snprintf(NULL, 0, "%d;%lu;%d;%f;%d;%d;%d;%d;%d;%f;%f;%d;%d;%f;%f;%f;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;", pysd_main.mcb.state, pysd_main.mcb.uptime, pysd_main.mcb.flight_time, pysd_main.mcb.battery_voltage, pysd_main.mcb.sensor_placeholder, pysd_main.vent_valve.waken_up, pysd_main.vent_valve.valve_state, pysd_main.vent_valve.thermistor1, pysd_main.vent_valve.thermistor2, pysd_main.vent_valve.tank_pressure, pysd_main.vent_valve.battery_voltage, pysd_main.main_valve.waken_up, pysd_main.main_valve.valve_state, pysd_main.main_valve.thermocouple1, pysd_main.main_valve.thermocouple2, pysd_main.main_valve.battery_voltage, pysd_main.recovery.isArmed, pysd_main.recovery.isTeleActive, pysd_main.recovery.easyMiniFirstStage, pysd_main.recovery.easyMiniSecondStage, pysd_main.recovery.telemetrumFirstStage, pysd_main.recovery.telemetrumSecondStage, pysd_main.recovery.firstStageDone, pysd_main.recovery.secondStageDone, pysd_main.recovery.firstStageContinouity, pysd_main.recovery.secondStageContinouity, pysd_main.recovery.separationSwitch1, pysd_main.recovery.separationSwitch2, pysd_main.recovery.pressure1, pysd_main.recovery.pressure2);
    }
...
size_t pysd_create_sd_frame(char *buffer, size_t size, rocket_data_t pysd_main, bool new_line_ending) {
    ...
    if (new_line_ending == true) {
        frame_size = snprintf(buffer, size, "%d;%lu;%d;%f;%d;%d;%d;%d;%d;%f;%f;%d;%d;%f;%f;%f;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;\n", pysd_main.mcb.state, pysd_main.mcb.uptime, pysd_main.mcb.flight_time, pysd_main.mcb.battery_voltage, pysd_main.mcb.sensor_placeholder, pysd_main.vent_valve.waken_up, pysd_main.vent_valve.valve_state, pysd_main.vent_valve.thermistor1, pysd_main.vent_valve.thermistor2, pysd_main.vent_valve.tank_pressure, pysd_main.vent_valve.battery_voltage, pysd_main.main_valve.waken_up, pysd_main.main_valve.valve_state, pysd_main.main_valve.thermocouple1, pysd_main.main_valve.thermocouple2, pysd_main.main_valve.battery_voltage, pysd_main.recovery.isArmed, pysd_main.recovery.isTeleActive, pysd_main.recovery.easyMiniFirstStage, pysd_main.recovery.easyMiniSecondStage, pysd_main.recovery.telemetrumFirstStage, pysd_main.recovery.telemetrumSecondStage, pysd_main.recovery.firstStageDone, pysd_main.recovery.secondStageDone, pysd_main.recovery.firstStageContinouity, pysd_main.recovery.secondStageContinouity, pysd_main.recovery.separationSwitch1, pysd_main.recovery.separationSwitch2, pysd_main.recovery.pressure1, pysd_main.recovery.pressure2);
    } else {
        frame_size = snprintf(buffer, size, "%d;%lu;%d;%f;%d;%d;%d;%d;%d;%f;%f;%d;%d;%f;%f;%f;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;", pysd_main.mcb.state, pysd_main.mcb.uptime, pysd_main.mcb.flight_time, pysd_main.mcb.battery_voltage, pysd_main.mcb.sensor_placeholder, pysd_main.vent_valve.waken_up, pysd_main.vent_valve.valve_state, pysd_main.vent_valve.thermistor1, pysd_main.vent_valve.thermistor2, pysd_main.vent_valve.tank_pressure, pysd_main.vent_valve.battery_voltage, pysd_main.main_valve.waken_up, pysd_main.main_valve.valve_state, pysd_main.main_valve.thermocouple1, pysd_main.main_valve.thermocouple2, pysd_main.main_valve.battery_voltage, pysd_main.recovery.isArmed, pysd_main.recovery.isTeleActive, pysd_main.recovery.easyMiniFirstStage, pysd_main.recovery.easyMiniSecondStage, pysd_main.recovery.telemetrumFirstStage, pysd_main.recovery.telemetrumSecondStage, pysd_main.recovery.firstStageDone, pysd_main.recovery.secondStageDone, pysd_main.recovery.firstStageContinouity, pysd_main.recovery.secondStageContinouity, pysd_main.recovery.separationSwitch1, pysd_main.recovery.separationSwitch2, pysd_main.recovery.pressure1, pysd_main.recovery.pressure2);
    }
