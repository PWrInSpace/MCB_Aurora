...
bool i2c_sensors_init(void) {
    return I2C_master_init(&gb.i2c_num_1, I2C_NUM_0, CONFIG_SDA_SEN, CONFIG_SCL_SEN);
}

bool i2c_com_init(void) {
    return I2C_master_init(&gb.i2c_num_2, I2C_NUM_1, CONFIG_SDA_COM, CONFIG_SCL_COM);
}
