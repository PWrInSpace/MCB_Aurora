...
#define RINGBUF_TYPE_NOSPLIT_HEADER_SIZE 8
#define SD_DATA_RINGBUF_CAPACITY CONFIG_SD_DATA_RINGBUF_CAPACITY
#define SD_LOG_RINGBUF_CAPACITY CONFIG_SD_LOG_RINGBUF_CAPACITY
#define SD_LOG_RINGBUF_SIZE (SD_LOG_RINGBUF_CAPACITY * (sizeof(char[SD_LOG_BUFFER_MAX_SIZE]) + RINGBUF_TYPE_NOSPLIT_HEADER_SIZE))
