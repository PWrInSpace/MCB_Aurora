...
#define VENT_VALVES_MAC {0x0c, 0xb8, 0x15, 0x51, 0x4d, 0x4c}
#define MAIN_VALVES_MAC {0xe8, 0x9f, 0x6d, 0xad, 0x3c, 0xb0}
#define OX_MAIN_VALVE_MAC {0xBA, 0x11, 0x22, 0x33, 0x44, 0x55}
#define ETH_VENT_VALVE_MAC {0x0C, 0xB8, 0x15, 0x51, 0x4D, 0x4D}
